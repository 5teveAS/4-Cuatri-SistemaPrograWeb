...
public class ReporteController implements Serializable {
    ...
    public void verPDF(){
        try {
            File jasper = new File(FacesContext.getCurrentInstance().getExternalContext().getRealPath("/prospecto/ProspectoK.jasper"));
    ...
    public void descargarPDF(){
        ...
        try {
            File jasper = new File(FacesContext.getCurrentInstance().getExternalContext().getRealPath("/reportes/CertificaJueves.jasper"));
